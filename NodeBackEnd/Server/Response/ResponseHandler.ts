...
class  ResponseHandler extends Engine{
    ...
    //         // so the to use columnbuilder you need a for(let i = 1; i < ColumnBuilder.length; i += 2)
    //         // This allows you to skip over the auto generated and access the columns. to get the definitions you just need to add 1 to the index
