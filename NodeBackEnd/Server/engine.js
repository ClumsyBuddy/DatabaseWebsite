...
export default class Engine {
    constructor(_DBController, _stores) {
        ...
        Object.keys(this.Stores).forEach((Name, i) => {
            ...
            this.ParseJson(`/Config/${Name}Brands.json`, (newValue) => {
    ...
    */
    ParseJson(FilePath, callback, db_Name) {
        let ParsedData;
        try {
    ...
    */
    UpdateItemInformation(newValue, Name) {
        this.Stores[Name].ItemDataArray = [];
        let AutoGeneratedClassColumn = this.Stores[Name].ClassAutoColumn === undefined ? "" : this.Stores[Name].ClassAutoColumn;
        console.log(newValue, " | " + this.Stores[Name].ClassAutoColumn, " | " + AutoGeneratedClassColumn);
        ...
        */
        this.DBController.getColumns(Name).then((result) => {
            ...
            */
            ...
            for (var type in this.Stores[Name].ItemTypes) { //Loop Through item types
                ...
                var Options = Object.keys(this.Stores[Name].Items[this.Stores[Name].ItemTypes[type]]); //Get all of the keys of the current item type
            ...
            */
            ...
            if (result.length == 0) { //If no table exist
                ...
                this.DBController.createTable(Name, TableColumn).then((result) => {
                });
            }
